...
def transport_hubs_select(y, n_features, cell_id, used_ids):
    ...
    to_drop = [ids for ids in used_ids if ids in traffic.columns or ids in [f'internet_traffic_{cell_id}']]
    traffic.drop(to_drop, axis=1, errors='ignore')
...
ids_to_use = [5160, 5161, 5060, 5061, 4861, 4761, 4360, 4259, 4359, 4350, 4351, 4352, 4353, 4452, 4453, 4454, 4455, 4456, 4556, 4456, 4356, 4355, 4354, 4250, 4251, 4252, 4253, 4254, 4255, 4256, 4156, 4155, 4154, 4153, 4151]
